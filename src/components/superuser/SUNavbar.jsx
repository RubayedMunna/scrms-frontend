...
function SUNavbar() {
    ...
    const fetchDashboardData = async (token) => {
        try {
            ...
            setUser(response.data.user); // Assuming 'teacher' is the key holding the user data
        } catch (error) {
    ...
    return (
        <div >
            <Navbar bg="primary" variant="dark" expand="lg" className="py-3 px-2">
                <Navbar.Brand onClick={handleHome} className="font-weight-bold text-uppercase">
                ...
                <Navbar.Collapse id="basic-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <Nav.Link onClick={handleUploadFile} className="text-light">
