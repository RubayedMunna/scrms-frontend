// src/components/SUForgotPassword.js

import React, { useState } from 'react';
import axios from 'axios';

const SUForgotPassword = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await axios.post('http://localhost:5002/api/auth/su-forgot-password', { email });
        ...
        return (
            <div className="container mt-5">
                <div className="alert alert-success text-center">
                    ...
                    <a href="/su-login" className="btn btn-primary">Return to SuperUser Login</a>
                </div>
            </div>
        );
    }
...
export default SUForgotPassword;
